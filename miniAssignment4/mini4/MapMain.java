...
/**
 * <b>Main interface for user to type input and makes use of the Map class.</b>
 *
 * Helper methods:
...
public class MapMain {
    ...
    /**
     *<p>A helper function that helps control console interactions. Handles receiving a valid integer for establishing
     * the dimensions of a Map object.  </p>
     *
     * @param prompt The question or option the console displays which looks for an integer.
     * @param dimension Defines the dimension the return value will go to.
     * @return int
     */
    ...
    /**
     * <p>A helper function that helps control console interactions. Handles receiving a valid character to be
     * placed onto the map. </p>
     *
     * @param prompt The question or option the console displays which looks for a character.
     * @return char
     */
